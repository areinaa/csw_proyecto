			...
			do {
				...
				case "USER":
					if(root.checkUser(request[2])) {
						//pw.println("OK " + this.number + " 201 Envie_contraseña");
						System.out.println("Función USER ha procedido correctamente");
				...
				case "PASS":
					if(!"0".equals(autentication)) 
						if(root.loginUser(this.autentication,request[2])) {
							...
							pw.println("FAILED " + this.number + " 403 Contraseña_incorrecta");
						}
					else
				...
				case "EXIT":
					...
					System.out.println("Conexión con cliente cerrada correctamente");
